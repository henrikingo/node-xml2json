...
Trait* cZip::clsTraits()
{
      static Trait TRAITS[] = {
         {      0,      Trait::TYPE_BEGIN,      "cZip",               0,                    0,              0,      cScr::clsTraits()  },
         {      0,      Trait::TYPE_FUN,        "cZip",               "add",                clsInvoke,      0,      0                  },
         {      1,      Trait::TYPE_FUN,        "cZip",               "zipTo",              clsInvoke,      1,      0                  },
         {      0,      Trait::TYPE_END,        "cZip",               0,                    0,              0,      0                  },
      };

      return TRAITS;
}

Trait* cZip::extTraits()
{
      static Trait TRAITS[] = {
         {      0,      Trait::TYPE_BEGIN,      "cZip",               0,                    0,              0,      0                  },
...
siEx cZip::clsInvoke(iScr* pthis, iCtx* ctx, int index, int argc,
           const Var* argv, Var* rval)
{
      siEx ex;
      cZip* pthis1 = (cZip*) pthis;
...
siEx cZip::extInvoke(iScr* pthis, iCtx* ctx, int index, int argc,
           const Var* argv, Var* rval)
{
      siEx ex;
      cZip* pthis1 = (cZip*) pthis;
...
Trait* cUnzip1::clsTraits()
{
      static Trait TRAITS[] = {
         ...
         {      4,      Trait::TYPE_FUN,        "cUnzip1",            "unzipTo",            clsInvoke,      4,      0                  },
           ...
           const Var* argv, Var* rval)
{
      ...
      switch(index) {
         ...
         case 4:
            if (argc != 2)
               return o3_new(cEx)("Invalid argument count. ( unzipTo )");
            *rval = pthis1->unzipTo(siFs (argv[0].toScr()),siFs (argv[1].toScr()),&ex);
            break;
      }
      return ex;
}
