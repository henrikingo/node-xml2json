...
Trait* cHttp::clsTraits()
{
      static Trait TRAITS[] = {
         {      0,      Trait::TYPE_BEGIN,      "cHttp",              0,                    0,              0,      cScr::clsTraits()  },
         {      0,      Trait::TYPE_GET,        "cHttp",              "READY_STATE_UNINITIALIZED",clsInvoke,      0,      0                  },
         {      1,      Trait::TYPE_GET,        "cHttp",              "READY_STATE_LOADING",clsInvoke,      1,      0                  },
         {      2,      Trait::TYPE_GET,        "cHttp",              "READY_STATE_LOADED", clsInvoke,      2,      0                  },
         {      3,      Trait::TYPE_GET,        "cHttp",              "READY_STATE_INTERACTIVE",clsInvoke,      3,      0                  },
         {      4,      Trait::TYPE_GET,        "cHttp",              "READY_STATE_COMPLETED",clsInvoke,      4,      0                  },
         {      5,      Trait::TYPE_GET,        "cHttp",              "readyState",         clsInvoke,      5,      0                  },
         {      6,      Trait::TYPE_FUN,        "cHttp",              "open",               clsInvoke,      6,      0                  },
         {      7,      Trait::TYPE_FUN,        "cHttp",              "setRequestHeader",   clsInvoke,      7,      0                  },
         {      8,      Trait::TYPE_FUN,        "cHttp",              "send",               clsInvoke,      8,      0                  },
         {      8,      Trait::TYPE_FUN,        "cHttp",              "send",               clsInvoke,      9,      0                  },
         {      9,      Trait::TYPE_GET,        "cHttp",              "statusText",         clsInvoke,      10,     0                  },
         {      10,     Trait::TYPE_GET,        "cHttp",              "statusCode",         clsInvoke,      11,     0                  },
         {      11,     Trait::TYPE_FUN,        "cHttp",              "getAllResponseHeaders",clsInvoke,      12,     0                  },
         {      12,     Trait::TYPE_FUN,        "cHttp",              "getResponseHeader",  clsInvoke,      13,     0                  },
         {      13,     Trait::TYPE_GET,        "cHttp",              "bytesTotal",         clsInvoke,      14,     0                  },
         {      14,     Trait::TYPE_GET,        "cHttp",              "bytesReceived",      clsInvoke,      15,     0                  },
         {      15,     Trait::TYPE_GET,        "cHttp",              "responseBlob",       clsInvoke,      16,     0                  },
         {      16,     Trait::TYPE_GET,        "cHttp",              "responseText",       clsInvoke,      17,     0                  },
         {      17,     Trait::TYPE_FUN,        "cHttp",              "abort",              clsInvoke,      18,     0                  },
         {      18,     Trait::TYPE_GET,        "cHttp",              "onreadystatechange", clsInvoke,      19,     0                  },
         {      18,     Trait::TYPE_SET,        "cHttp",              "onreadystatechange", clsInvoke,      20,     0                  },
         {      19,     Trait::TYPE_GET,        "cHttp",              "onprogress",         clsInvoke,      21,     0                  },
         {      19,     Trait::TYPE_SET,        "cHttp",              "onprogress",         clsInvoke,      22,     0                  },
         {      20,     Trait::TYPE_FUN,        "cHttp",              "responseOpen",       clsInvoke,      23,     0                  },
         {      0,      Trait::TYPE_END,        "cHttp",              0,                    0,              0,      0                  },
      };

      return TRAITS;
}

Trait* cHttp::extTraits()
{
      static Trait TRAITS[] = {
         {      0,      Trait::TYPE_BEGIN,      "cHttp",              0,                    0,              0,      0                  },
...
siEx cHttp::clsInvoke(iScr* pthis, iCtx* ctx, int index, int argc,
           const Var* argv, Var* rval)
{
      siEx ex;
      cHttp* pthis1 = (cHttp*) pthis;
...
siEx cHttp::extInvoke(iScr* pthis, iCtx* ctx, int index, int argc,
           const Var* argv, Var* rval)
{
      siEx ex;
      cHttp* pthis1 = (cHttp*) pthis;
