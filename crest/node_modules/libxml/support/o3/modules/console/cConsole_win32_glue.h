...
Trait* cConsole::select()
{
   return clsTraits();
}

Trait* cConsole::clsTraits()
{
      static Trait TRAITS[] = {
         {      0,      Trait::TYPE_BEGIN,      "cConsole",           0,                    0,              0,      cScr::clsTraits()  },
         {      0,      Trait::TYPE_END,        "cConsole",           0,                    0,              0,      0                  },
      };

      return TRAITS;
}

Trait* cConsole::extTraits()
{
      static Trait TRAITS[] = {
         {      0,      Trait::TYPE_BEGIN,      "cConsole",           0,                    0,              0,      0                  },
...
siEx cConsole::clsInvoke(iScr* pthis, iCtx* ctx, int index, int argc,
...
siEx cConsole::extInvoke(iScr* pthis, iCtx* ctx, int index, int argc,
           const Var* argv, Var* rval)
{
      siEx ex;
      cConsole* pthis1 = (cConsole*) pthis;
