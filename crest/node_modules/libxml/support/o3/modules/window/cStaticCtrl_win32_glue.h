...
Trait* cStaticCtrl::select()
{
   return clsTraits();
}

Trait* cStaticCtrl::clsTraits()
{
      static Trait TRAITS[] = {
         {      0,      Trait::TYPE_BEGIN,      "cStaticCtrl",        0,                    0,              0,      cWindow::clsTraits()  },
         {      0,      Trait::TYPE_END,        "cStaticCtrl",        0,                    0,              0,      0                  },
      };

      return TRAITS;
}

Trait* cStaticCtrl::extTraits()
{
      static Trait TRAITS[] = {
         {      0,      Trait::TYPE_BEGIN,      "cStaticCtrl",        0,                    0,              0,      0                  },
         {      0,      Trait::TYPE_FUN,        "cWindow",            "createTextbox",      extInvoke,      0,      0                  },
         {      1,      Trait::TYPE_FUN,        "cWindow",            "createBlank",        extInvoke,      1,      0                  },
         {      2,      Trait::TYPE_FUN,        "cWindow",            "createSeparator",    extInvoke,      2,      0                  },
         {      3,      Trait::TYPE_FUN,        "cWindow",            "createImgbox",       extInvoke,      3,      0                  },
         {      0,      Trait::TYPE_END,        "cStaticCtrl",        0,                    0,              0,      0                  },
      };
...
siEx cStaticCtrl::clsInvoke(iScr* pthis, iCtx* ctx, int index, int argc,
...
siEx cStaticCtrl::extInvoke(iScr* pthis, iCtx* ctx, int index, int argc,
           const Var* argv, Var* rval)
{
      siEx ex;
      cStaticCtrl* pthis1 = (cStaticCtrl*) pthis;
