...
#include "../include/agg_path_storage_integer.h"
...
namespace agg
{
    ...
    public:
		...
		bool char_map(::o3::freetype::FT_Encoding map);
		...
		::o3::freetype::FT_Encoding char_map()     const { return m_char_map;   }
    ...
    private:
        ...
        ::o3::freetype::FT_Encoding     m_char_map;
        char*           m_signature;
        unsigned        m_height;
        unsigned        m_width;
        bool            m_hinting;
        ...
        ::o3::freetype::FT_Library      m_library;    // handle to library    
        ::o3::freetype::FT_Face*        m_faces;      // A pool of font faces
        char**          m_face_names; 
        unsigned        m_num_faces;
        unsigned        m_max_faces;
        ::o3::freetype::FT_Face         m_cur_face;  // handle to the current face object
        int             m_resolution;
