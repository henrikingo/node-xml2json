...
#include "../include/agg_bitset_iterator.h"
...
namespace agg
{
	...
	bool decompose_ft_outline(const ::o3::freetype::FT_Outline& outline,
                              bool flip_y,
    ...
    {   
        ...
        ::o3::freetype::FT_Vector   v_last;
        ::o3::freetype::FT_Vector   v_control;
        ::o3::freetype::FT_Vector   v_start;
        double x1, y1, x2, y2, x3, y3;

        ::o3::freetype::FT_Vector*  point;
        ::o3::freetype::FT_Vector*  limit;
        char*       tags;
            ...
            while(point < limit)
            {
                ...
                switch(tag)
                {
                    ...
                    Do_Conic:
                        if(point < limit)
                        {
                            ::o3::freetype::FT_Vector vec;
                            ::o3::freetype::FT_Vector v_middle;
                    ...
                    {
						::o3::freetype::FT_Vector vec1, vec2;
    ...
    void decompose_ft_bitmap_mono(const ::o3::freetype::FT_Bitmap& bitmap,
                                  int x, int y,
                                  bool flip_y,
                                  Scanline& sl,
    ...
    void decompose_ft_bitmap_gray8(const ::o3::freetype::FT_Bitmap& bitmap,
                                   int x, int y,
                                   bool flip_y,
                                   Rasterizer& ras,
                                   Scanline& sl,
    ...
    font_engine_freetype_base::~font_engine_freetype_base()
    {
        ...
        for(i = 0; i < m_num_faces; ++i)
        {
            ...
            ::o3::freetype::FT_Done_Face(m_faces[i]);
        }
        delete [] m_face_names;
        delete [] m_faces;
        delete [] m_signature;
        if(m_library_initialized) ::o3::freetype::FT_Done_FreeType(m_library);
    }
    ...
    font_engine_freetype_base::font_engine_freetype_base(bool flag32, 
        ...
        m_name_len(256-16-1),
        m_face_index(0),
        m_char_map(::o3::freetype::FT_ENCODING_NONE),
        ...
        m_library(0),
        m_faces(new ::o3::freetype::FT_Face [max_faces]),
        ...
        if(m_library_initialized)
        {
            ...
            else
            {
                if(m_num_faces >= m_max_faces)
                {
                    ...
                    ::o3::freetype::FT_Done_Face(m_faces[0]);
                    memcpy(m_faces, 
                           m_faces + 1, 
                           (m_max_faces - 1) * sizeof(::o3::freetype::FT_Face));
                    memcpy(m_face_names, 
                           m_face_names + 1, 
                ...
                {
                    m_last_error = ::o3::freetype::FT_New_Memory_Face(m_library, 
                                                      (const ::o3::freetype::FT_Byte*)font_mem, 
                                                      font_mem_size, 
                                                      face_index, 
                                                      &m_faces[m_num_faces]);
                }
                ...
                {
                    m_last_error = ::o3::freetype::FT_New_Face(m_library,
                                               font_name,
                                               face_index,
                                               &m_faces[m_num_faces]);
                }
    ...
    bool font_engine_freetype_base::attach(const char* file_name)
    {
        if(m_cur_face)
        {
            m_last_error = ::o3::freetype::FT_Attach_File(m_cur_face, file_name);
    ...
    //------------------------------------------------------------------------
    bool font_engine_freetype_base::char_map(::o3::freetype::FT_Encoding char_map)
    {
        if(m_cur_face)
        {
...
//                                     m_hinting ? FT_LOAD_FORCE_AUTOHINT : FT_LOAD_NO_HINTING);
        if(m_last_error == 0)
        {
            ...
            {
            case glyph_ren_native_mono:
                m_last_error = ::o3::freetype::FT_Render_Glyph(m_cur_face->glyph, ::o3::freetype::FT_RENDER_MODE_MONO);
                if(m_last_error == 0)
                {
            ...
            case glyph_ren_native_gray8:
                m_last_error = FT_Render_Glyph(m_cur_face->glyph, ::o3::freetype::FT_RENDER_MODE_NORMAL);
                if(m_last_error == 0)
                {
                                           ...
                                           double* x, double* y)
    {
        ...
        {
            ::o3::freetype::FT_Vector delta;
            ::o3::freetype::FT_Get_Kerning(m_cur_face, first, second,
                           ::o3::freetype::FT_KERNING_DEFAULT, &delta);
