...
LOCAL(void)
jctrans_start_iMCU_row (j_compress_ptr cinfo)
...
METHODDEF(void)
jctrans_start_pass_coef (j_compress_ptr cinfo, J_BUF_MODE pass_mode)
{
  jctrans_my_coef_ptr coef = (jctrans_my_coef_ptr) cinfo->coef;
			     ...
			     jvirt_barray_ptr * coef_arrays)
{
  ...
  coef->pub.start_pass = jctrans_start_pass_coef;
  coef->pub.compress_data = jctrans_compress_output;
