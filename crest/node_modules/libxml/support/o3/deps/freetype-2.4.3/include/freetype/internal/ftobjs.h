...
//#include <ft2build.h>
#include "../ftrender.h"
#include "../ftsizes.h" // FT_SIZES_H
#include "../ftlcdfil.h" //FT_LCD_FILTER_H
#include "ftmemory.h" //FT_INTERNAL_MEMORY_H
#include "ftgloadr.h" //FT_INTERNAL_GLYPH_LOADER_H
#include "ftdriver.h" //FT_INTERNAL_DRIVER_H
#include "autohint.h" //FT_INTERNAL_AUTOHINT_H
#include "ftserv.h" //FT_INTERNAL_SERVICE_H
